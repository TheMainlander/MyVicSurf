-- Sample Marketing Documents for VicSurf Admin System
INSERT INTO marketing_documents (title, description, content, type, format, created_by) VALUES 

('VicSurf Market Entry Strategy 2025', 'Comprehensive strategy for capturing market share from Surfline and Magicseaweed', 
'# VicSurf Market Entry Strategy 2025
...
- Q4 2025: Advanced forecasting and AI features', 'strategy', 'md', 'Admin'),

('Victorian Surf Community Campaign', 'Grassroots marketing campaign targeting local surf communities', 
'# Victorian Surf Community Campaign
...
- Partner integrations: 5 key partnerships', 'campaign', 'md', 'Admin'),

('Competitor Analysis Report Q1 2025', 'Deep dive analysis of Surfline and Magicseaweed market positioning', 
...
4. Build community features competitors lack', 'analysis', 'md', 'Admin'),

('VicSurf Revenue Model Proposal', 'Detailed proposal for freemium model and premium feature differentiation', 
'# VicSurf Revenue Model Proposal
...
- Month 12: Launch additional premium tiers', 'proposal', 'md', 'Admin'),

('Q4 2024 User Engagement Report', 'Analysis of user behavior patterns and engagement metrics', 
'# Q4 2024 User Engagement Report
...
4. **Analytics**: Implement advanced user journey tracking', 'report', 'md', 'Admin');